...
(function (h) {
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: {sFirst: "Первая", sLast: "Последняя", sNext: "Следущий", sPrevious: "Предидущий"},
            sEmptyTable: "Не найдена записи в таблице",
            sInfo: "Показать _START_ по _END_ из _TOTAL_ записей",
            sInfoEmpty: "Показать 0 по 0 из 0 записей",
            sInfoFiltered: "(Фильтрация из _MAX_ записей)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
