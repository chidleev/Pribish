...
$id = $_GET["id"];
$res = mysqli_query($dbcon, "select * from autoriz where id='" . $id . "';");
            ...
            <main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
                ...
                <section class="row">
                    <div class="col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input id="mm_email" name="lname" type="text"
                                                               ...
                                                               class="form-control" value="<?php echo $familia ; ?>">
                                                    </div>
                        ...
                        if (isset($_POST["reg"]))
                        {
                            if ((!empty($_POST["uname"])) and (!empty($_POST["fname"])) and (!empty($_POST["lname"])) and (!empty($_POST["pass"]))) {



                                $mysql="UPDATE autoriz SET login ='$_POST[uname]', name ='$_POST[fname]', familia ='$_POST[lname]', password ='$_POST[pass]'  WHERE id = '".$id."'";
                                ...
                                ?>
                                <script>
                                    window.location.href = "see_users.php";
                                </script>
                            <?php
                            ?>
