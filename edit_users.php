...
$id = $_GET["id"];
$res = mysqli_query($dbcon, "select * from infus where id='" . $id . "';");
                ...
                <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input id="mm_FIO" name="mm_FIO" type="text"
                                                           ...
                                                           class="form-control" value="<?php echo $FIO; ?>">
                                                </div>
                                                ...
                                                <div class="col-md-9">
                                                    <select class="form-control input100" id="exampleFormControlSelect1" name="mm_groupp">
                                                        <option selected>Выберите вместо <?php echo $grup ; ?></option>
                                                        <?php
                                                ...
                                                <div class="col-md-9">
                                                    <input id="mm_email" name="mm_pasport" type="text"
                                                           ...
                                                           class="form-control" value="<?php echo $pasport ; ?>">
                                                </div>
                                                ...
                                                <div class="col-md-9">
                                                    <select class="form-control input100" id="exampleFormControlSelect1" name="mm_obr">
                                                        <option selected>Выберити вместо<?php echo $obraz ; ?></option>
                                                ...
                                                <div class="col-md-9">
                                                    <select class="form-control input100" id="exampleFormControlSelect1" name="mm_dip">
                                                        <option selected>Выбирите вместо <?php echo $diplom; ?></option>
                                                ...
                                                <div class="col-md-9">
                                                    <input id="mm_tel" name="mm_rozd" type="text"
                                                           ...
                                                           class="form-control" value="<?php echo $rozden ; ?>">
                                                </div>
                                                ...
                                                <div class="col-md-9">
                                                    <input id="mm_tel" name="mm_gor" type="text"
                                                           ...
                                                           class="form-control" value="<?php echo $town ; ?>">
                                                </div>
                    ...
                    if (isset($_POST["add4"]))
                    {
                        if ((!empty($_POST["mm_FIO"]))  and (!empty($_POST["mm_pasport"]))   and (!empty($_POST["mm_rozd"])) and (!empty($_POST["mm_gor"]))) {
                            ...
                            $mysql="UPDATE infus SET FIO ='$_POST[mm_FIO]', grup ='$_POST[mm_groupp]', pasport ='$_POST[mm_pasport]', obraz ='$_POST[mm_obr]', diplom ='$_POST[mm_dip]', rozden ='$_POST[mm_rozd]', town ='$_POST[mm_gor]'  WHERE id = '".$id."'";
                            ...
                            ?>
                            <script>
                                window.location.href = "see_info.php";
                            </script>
                        <?php
                        ?>
